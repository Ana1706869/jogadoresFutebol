...
import com.example.jogadoresfutebol.databinding.FragmentListaJogadoresBinding

val ID_LOADER_JOGADORES=0
class ListaJogadoresFragment :Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    var jogadorSelecionado : Jogadores? = null
        set(value) {
            field = value
    ...
    private fun adicionaJogador() {
        val acao = ListaJogadoresFragmentDirections.actionListaJogadoresFragmentToEditarJogadorFragment(null)
        findNavController().navigate(acao)
