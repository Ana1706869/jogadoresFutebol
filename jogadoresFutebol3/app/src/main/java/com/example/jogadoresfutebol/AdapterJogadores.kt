...
class AdapterJogadores( val fragment: ListaJogadoresFragment) : RecyclerView.Adapter<AdapterJogadores.ViewHolderJogadores>() {
    ...
    inner class ViewHolderJogadores(contentor: View) : ViewHolder(contentor) {
        private val textViewJogador = contentor.findViewById<TextView>(R.id.textViewNome)
        ...
        internal var jogador: Jogadores? = null
            set(value) {
                field = value
                textViewJogador.text = jogador?.nome ?: ""
    ...
    private var viewHolderSeleccionado : ViewHolderJogadores? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderJogadores {
        return ViewHolderJogadores(
            fragment.layoutInflater.inflate(R.layout.item_jogador, parent, false)
        )
    }
    ...
    override fun onBindViewHolder(holder: ViewHolderJogadores, position: Int) {
        ...
        holder.jogador = Jogadores.fromCursor(cursor!!)
    }
}